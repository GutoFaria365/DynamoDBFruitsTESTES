...
public abstract class AbstractService {
    ...
    protected PutItemRequest putRequest(Fruit fruit) {
        ...
        item.put("SK", AttributeValue.builder().s("FRUIT#" + fruit.getName().toUpperCase()).build());
        item.put(FRUIT_NAME_COL, AttributeValue.builder().s(fruit.getName().toUpperCase()).build());
        item.put(FRUIT_DESC_COL, AttributeValue.builder().s(fruit.getDescription().toUpperCase()).build());
        item.put("GSI1PK", AttributeValue.builder().s("TASTE#").build());
        item.put("GSI1SK", AttributeValue.builder().s("TASTE#" + fruit.getDescription().toUpperCase()).build());
